public class Image {
	...
	/*
	Returns the Euclidean distance between this Image and the compareImage (ClusteredImage)
	passed as argument
 	*/
	public double getEuclideanDistance2(ClusteredImage compareImage) {
		final double errorValue = -999;
		double output = 0;
		try {
			// Check that both this Image and compareImage have the same number of digitData elements
			...
			System.out.println ("Image.getEuclideanDistance2 - an error has occurred: " + e.getMessage());
			return errorValue;
		}
	}
